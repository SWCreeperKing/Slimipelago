...
| Burn             | Radiation         |
| Buyon            | Tarr              |
| Camera Rotate    | Screen Flip       |
| Chaos Control    | Freeze            |
| Confound         | Screen Flip       |
| Confuse          | Screen Flip       |
| Confusion        | Screen Flip       |
| Cutscene         | Text              |
| Damage           | Damage            |
| Deisometric      | Zoom              |
| Depletion        | Energy Drain      |
| Disable A        | No Vac            |
| Disable B        | No Vac            |
| Disable C Up     | No Vac            |
| Disable Tag      | No Vac            |
| Disable Z        | No Vac            |
| Double Damage    | Radiation         |
| Dry              | Energy Drain      |
| Eject Ability    | Whoops!           |
| Electrocution    | Radiation         |
| Empty Item Box   | Market Crash      |
| Energy Drain     | Energy Drain      |
| Expensive Stocks | Market Crash      |
| Exposition       | Text              |
| Fear             | Tarr              |
| Fire             | Radiation         |
| Fishin' Boo      | Tarr              |
...
| Ice Floor        | Whoops!           |
| Ice              | Freeze            |
| Icy Hot Pants    | Whoops!           |
| Input Sequence   | Freeze            |
| Instant Crystal  | Damage            |
| Instant Death    | Ranch             |
