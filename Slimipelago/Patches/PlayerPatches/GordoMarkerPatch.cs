...
public static class GordoMarkerPatch
{
    ...
    public static bool DisplayMarker(GordoDisplayOnMap __instance, ref bool __result, GordoEat ___gordoEat)
    {
        if (__instance.name.StartsWith("gordoGold") || ___gordoEat.HasPopped())
